...
const handleTreated = (req, res, db) => {
    ...
    const { doc_id, pat_id, date, time_slot, medCode} = req.body;
...
const handleGetDoctorMetrics = (req, res, db) => {
    const doctor_ID = req.params.doc_id; // get patient ID from request params
...
const handlePrescription = (req, res, db) => {
    const { medicine, medCode } = req.body;
...
module.exports = {
    ...
    handleGetDoctorMetrics:handleGetDoctorMetrics
}